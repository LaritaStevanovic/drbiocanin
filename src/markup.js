    ...
    <div class="wrap">
      <div class="contact-grid" style="display:grid; grid-template-columns:1fr 1.2fr; gap:56px; align-items:center;">
        ...
        <a href="https://maps.app.goo.gl/ZxnDW3sB2YjWgU4w6" target="_blank" rel="noopener" style="position:relative; display:block; aspect-ratio:16/11; border:1px solid #dde4e9; border-radius:12px; overflow:hidden;">
          <iframe title="Mapa - Ranka Miljića 81, Borča" src="https://www.google.com/maps?q=Ranka%20Milji%C4%87a%2081%2C%20Bor%C4%8Da%2C%20Beograd&z=16&output=embed" width="600" height="413" loading="lazy" referrerpolicy="no-referrer-when-downgrade" style="width:100%; height:100%; border:0; display:block; pointer-events:none;"></iframe>
